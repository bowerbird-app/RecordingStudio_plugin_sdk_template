RecordingStudioPluginSdkTemplate install complete.

Next steps:

1. Review config/initializers/recording_studio_plugin_sdk_template.rb and set any required options.
2. If you use environment-specific settings, create config/recording_studio_plugin_sdk_template.yml.
3. Install the engine migrations with `bin/rails generate recording_studio_plugin_sdk_template:migrations`.
