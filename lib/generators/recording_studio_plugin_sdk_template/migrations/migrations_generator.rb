...
module RecordingStudioPluginSdkTemplate
  module Generators
    # Generator to install RecordingStudioPluginSdkTemplate migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_plugin_sdk_template:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioPluginSdkTemplate migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioPluginSdkTemplate engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_plugin_sdk_template_pages.rb")
