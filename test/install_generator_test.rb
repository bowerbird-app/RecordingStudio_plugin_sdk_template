...
require "fileutils"
require "tmpdir"
require "generators/recording_studio_plugin_sdk_template/install/install_generator"

class InstallGeneratorTest < Minitest::Test
  INSTALL_TEMPLATE_PATH = File.expand_path(
    "../lib/generators/recording_studio_plugin_sdk_template/install/templates/INSTALL.md",
    __dir__
  )
  ...
  def build_generator(destination_root, options = {})
    RecordingStudioPluginSdkTemplate::Generators::InstallGenerator.new(
      [],
      options,
  ...
  def test_mount_engine_uses_configured_mount_path
    ...
    assert_equal ["mount RecordingStudioPluginSdkTemplate::Engine, at: \"/addons/recording\""], routes
  end
  ...
  def test_install_guide_includes_migration_and_host_setup_steps
    ...
    assert_includes install_guide, "bin/rails generate recording_studio_plugin_sdk_template:migrations"
