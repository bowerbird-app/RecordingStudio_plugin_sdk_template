...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioPluginSdkTemplate::Engine.root}/"

    @engine_views = Dir.glob(
      RecordingStudioPluginSdkTemplate::Engine.root.join(
        "app/views/recording_studio_plugin_sdk_template/**/*.erb"
      ).to_s
    )
      .sort
